    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "first_name",
                    models.CharField(blank=True, max_length=156, verbose_name="first name"),
                ),
                (
                    "last_name",
                    models.CharField(blank=True, max_length=156, verbose_name="last name"),
                ),
                (
                    "birthdate",
                    models.DateField(blank=True, null=True, verbose_name="birthday"),
                ),
                ("is_tattoo_master", models.BooleanField(blank=True, default=False)),
                (
                    "phone",
                    phonenumber_field.modelfields.PhoneNumberField(
                        ...
                        null=True,
                        region=None,
                        validators=[django.core.validators.RegexValidator("^\\d{3}-\\d{3}-\\d{4}$")],
